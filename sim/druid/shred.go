...
const ShredWeaponMultiplierBuff = 0.75 // increase multiplier additively by +75% from 2.25 to 3.0
...
func (druid *Druid) registerShredSpell() {
	...
	// Shred mod, and to the flat damage bonus, but that the +0.75x SoD buff happens additively after Idol.
